...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen momentum-bg dot-grid-subtle text-slate-900 pb-32 font-sans selection:bg-orange-500 selection:text-white ui-page relative">
            ...
            {!isPremiumActive && (
                <div className="mx-6 mb-4 ui-glass surface-orange border border-amber-100 rounded-2xl p-4 flex items-center justify-between gap-3 ui-card">
                    <div>
                    ...
                    <button
                        ...
                        className="px-3 py-2 rounded-xl bg-amber-500 text-white text-xs font-black ui-card whitespace-nowrap"
                    >
                        Upgrade
                    </button>
                </div>
            ...
            {showPremiumExpiryWarning && (
                <div className="mx-6 mb-4 ui-glass surface-rose border border-rose-100 rounded-2xl p-4 flex items-center justify-between gap-3 ui-card">
                    <div>
                    ...
                    <button
                        onClick={() => setIsPaywallOpen(true)}
                        className="px-3 py-2 rounded-xl bg-rose-500 text-white text-xs font-black ui-card whitespace-nowrap"
                    >
                        Renew
                    </button>
                </div>
                ...
                {(() => {
                    ...
                    return (
                        <div className="flex items-center gap-2">
                            <button onClick={() => shiftCalendar('past')} className="w-8 h-8 flex items-center justify-center rounded-full ui-glass border border-slate-100 ui-card text-slate-400 hover:text-slate-200 hover:border-slate-300 transition-all flex-shrink-0">
                            ...
                            <button onClick={() => shiftCalendar('future')} className="w-8 h-8 flex items-center justify-center rounded-full ui-glass border border-slate-100 ui-card text-slate-400 hover:text-slate-200 hover:border-slate-300 transition-all flex-shrink-0">
            ...
            <div className="px-6 space-y-16 mt-6">
                    ...
                    <div className="flex items-center justify-between gap-6">
                        ...
                        <div className="relative w-32 h-32 flex-shrink-0">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                ...
                                <span className="text-xs font-bold text-slate-400 mt-1">/ {targetKcal} kcal</span>
                            </div>
                        </div>
                        {/* Macros */}
                ...
                <div className="grid grid-cols-2 gap-4 px-6 mb-8 mt-[-1rem]">
                    ...
                    <div className="ui-glass surface-violet rounded-[2rem] p-5 ui-card flex flex-col gap-3 h-48">
                        ...
                        {weeklyWeightChange !== null ? (
                            <p className={`text-xs font-bold flex items-center gap-1 ${weeklyWeightChange <= 0 ? 'text-[#22c55e]' : 'text-rose-500'}`}>
                            ...
                            <p className="text-xs font-medium text-slate-400">No data yet</p>
                        )}
                        {(() => {
                ...
                <div className="px-6 mb-6">
                    ...
                    <div className="relative pl-5 space-y-6 before:absolute before:inset-y-6 before:left-[25px] before:w-[2px] before:bg-slate-700/40">
                                            ...
                                            <div className="ui-glass surface-emerald rounded-2xl p-4 ui-card ml-4">
                                                <div className="flex items-center gap-4 w-full">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <p className="text-xs text-slate-500 font-medium mt-0.5 pr-2 leading-relaxed">{activeDay.nutritionTip}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            >
                                                <div className="flex items-start justify-between mb-3">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-slate-500 font-medium mt-0.5">{activeDay.exercises.length} movements scheduled</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="space-y-1.5 pl-14">
                                                    {activeDay.exercises.slice(0, 3).map((ex: { name: string; sets?: number; durationOrReps: string }, idx: number) => (
                                                        <div key={idx} className="flex justify-between items-end text-xs border-b border-slate-50 pb-1.5 last:border-0 last:pb-0">
                                                    ...
                                                    {activeDay.exercises.length > 3 && (
                                                        <p className="text-xs text-slate-400 font-medium italic pt-1">+{activeDay.exercises.length - 3} more...</p>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="relative animate-in fade-in slide-in-from-bottom-2 duration-500 delay-100">
                                            ...
                                            <div className="ui-glass surface-blue rounded-2xl p-4 ui-card flex items-center gap-4 ml-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-500 font-medium mt-0.5">Focus on mobility and stretching.</p>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {isToday && (
                                        <div className="relative pt-2 animate-in fade-in slide-in-from-bottom-2 duration-500 delay-200">
                                            ...
                                            <div
                                                ...
                                                className="ui-glass rounded-2xl p-4 border border-dashed border-slate-300 flex items-center justify-center ml-4 cursor-pointer hover:bg-slate-100 hover:border-slate-400 transition-colors"
                                            >
                    ...
                    <div className="fixed inset-0 bg-slate-900/40 z-[60] flex items-end sm:items-center justify-center p-4 sm:p-6 backdrop-blur-sm animate-in fade-in duration-200">
                        <div className="ui-glass-strong rounded-3xl p-5 sm:p-6 w-full max-w-sm max-h-[85vh] overflow-y-auto pb-[calc(1.25rem+env(safe-area-inset-bottom))] ui-elevated border border-slate-100">
                            ...
                            <button
                                ...
                                className="w-full bg-[#f97316] hover:bg-orange-600 text-white font-extrabold py-4 rounded-xl transition-colors ui-elevated "
                            >
                                Save Meal Log
                            </button>
                        </div>
                        ...
                        <div className="ui-glass-strong rounded-[2rem] p-5 sm:p-6 w-full max-w-sm max-h-[85vh] overflow-y-auto pb-[calc(1.25rem+env(safe-area-inset-bottom))] relative z-10 ui-elevated animate-in zoom-in-95 duration-200">
                            ...
                            <div className="relative mb-6">
                                <input
                                    ...
                                    placeholder="e.g. 500"
                                    className="w-full ui-glass border-2 border-slate-100 rounded-2xl px-4 py-4 text-center text-2xl sm:text-3xl font-black text-slate-900 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all font-sans"
                                    autoFocus
                                />
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    ...
                                    className="py-3 rounded-xl font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 transition-colors border-none outline-none focus:outline-none"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    style={{ WebkitTapHighlightColor: 'transparent', outline: 'none' }}
                                    className="py-3 rounded-xl font-bold text-white bg-[#f97316] hover:bg-orange-600 disabled:opacity-50 disabled:pointer-events-none transition-colors ui-elevated  border-none outline-none focus:outline-none focus:ring-0 focus-visible:outline-none"
                                >
                                    Log It
                                </button>
                            </div>
                            ...
                            <div className="flex-1 overflow-y-auto pr-2 -mr-2 space-y-3 mb-6">
                                {plan.days[selectedOffset].exercises?.map((ex: any, idx: number) => (
                                    <div key={idx} className="bg-slate-50 border border-slate-100 rounded-2xl p-3.5 sm:p-4 flex justify-between items-center group hover:border-[#f97316]/30 transition-colors">
                                        <div className="flex items-center gap-3">
                                            <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center text-xs font-black text-slate-400 ui-card">
                                                {idx + 1}
                                            </div>
                                            <span className="font-bold text-slate-700">{ex.name}</span>
                                        </div>
                                        <div className="text-right">
                                            ...
                                            {ex.sets && <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">{ex.sets} Sets</span>}
                                        </div>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="pt-2 border-t border-slate-100 mt-auto">
                                {isToday ? (
                                    isTodayWorkoutCompleted ? (
                                        ...
                                        <Link
                                            href="/log?plan=today"
                                            className="w-full bg-[#f97316] hover:bg-orange-600 text-white font-extrabold py-4 rounded-xl flex items-center justify-center gap-2 transition-colors ui-elevated "
                                        >
            ...
            {isNoticeOpen && (
                <div className="fixed inset-0 z-[85] flex items-center justify-center px-5">
                    ...
                    <div className="relative w-full max-w-md ui-glass-strong rounded-[1.5rem] p-5 border border-slate-100 ui-elevated">
                        ...
                        <button
                            onClick={() => setIsNoticeOpen(false)}
                            className="mt-5 w-full py-3 rounded-xl accent-gradient text-white text-sm font-bold transition-colors"
                        >
                            OK
                        </button>
                    </div>
