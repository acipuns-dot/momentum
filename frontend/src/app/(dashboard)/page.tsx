                                ...
                                <>
                                    ...
                                    {activeDay.type === 'workout' && activeDay.exercises && (
                                        <div className="relative animate-in fade-in slide-in-from-bottom-2 duration-500 delay-100">
                                            ...
                                            <Link
                                                href={isToday ? '/log' : '#'}
                                                className={`bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex flex-col ml-4 transition-colors group ${isToday ? 'hover:border-slate-200 cursor-pointer' : 'opacity-80 cursor-default'}`}
                                            >
